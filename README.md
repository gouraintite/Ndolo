...
Le frein numéro un d'un donateur — surtout dans la diaspora — n'est pas *« je ne connais pas ce centre »*, c'est **« comment je sais que mon argent arrive vraiment à l'enfant ? »**.
...
*Ndolo est un projet en construction. Le nom est provisoire — find-replace pour renommer.*
